...
pinMode(10, OUTPUT);
  ...
  if (!SD.begin(10)) 
 {
  ...
  myFile = SD.open("test.txt", FILE_WRITE);                                    //WHERE YOU CHANGE THE NAME OF THE FILE
  myFile.close();
...
myFile.close();
     myFile = SD.open("test.txt", FILE_WRITE);
    myFile.print(GPS.milliseconds);  myFile.print(", ");
myFile.close();
     myFile = SD.open("test.txt", FILE_WRITE);
    myFile.print("Date:, ");
myFile.close();
...
myFile.close();
     myFile = SD.open("test.txt", FILE_WRITE);
    myFile.print("Fix:, "); myFile.print((int)GPS.fix); myFile.print(", ");
myFile.close();
     myFile = SD.open("test.txt", FILE_WRITE);
    myFile.print(" quality:, "); myFile.print((int)GPS.fixquality); myFile.print(", ");
myFile.close();
...
myFile.close();
       myFile = SD.open("test.txt", FILE_WRITE);
      myFile.print("Speed (knots):, "); myFile.print(GPS.speed); myFile.print(", ");
myFile.close();
       myFile = SD.open("test.txt", FILE_WRITE);
      myFile.print("Angle:, "); myFile.print(GPS.angle); myFile.print(", ");
myFile.close();
       myFile = SD.open("test.txt", FILE_WRITE);
      myFile.print("Altitude:, "); myFile.print(GPS.altitude); myFile.print(", ");
myFile.close();
       myFile = SD.open("test.txt", FILE_WRITE);
